...
public class SelectCityHeaderBean extends BaseIndexPinyinBean {
    ...
    public SelectCityHeaderBean(List<String> cityList, String suspensionTag, String indexBarTag) {
    ...
    public SelectCityHeaderBean setCityList(List<String> cityList) {
        this.cityList = cityList;
        return this;
    }

    public SelectCityHeaderBean setSuspensionTag(String suspensionTag) {
        this.suspensionTag = suspensionTag;
        return this;
    }
